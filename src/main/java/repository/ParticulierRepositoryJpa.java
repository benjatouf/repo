...
public class ParticulierRepositoryJpa implements IParticulierRepository {
	...
	public List<Particulier> findAll() {
		...
		try {
			...
			TypedQuery<Particulier> query = em.createQuery("select f from Particulier f", Particulier.class);
